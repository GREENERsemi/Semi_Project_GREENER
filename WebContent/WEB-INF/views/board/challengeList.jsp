<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="member.model.vo.*, board.model.vo.*, java.util.ArrayList, notice.model.vo.*"%>
<%
  ...
  <div class="row">
   ...
   <div class="container">
	...
	<!-- 				<div class="table-wrap"> -->
						<table class="table table-hover" id="listArea" width="100px">
	...
	<!-- 				</div> -->
      ...
      <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="<%= request.getContextPath() %>/chalList.bo?currentPage=1" aria-label="Previous">
          ...
          <% for(int pi = p.getStartPage(); pi <= p.getEndPage(); pi++){ %>
             ...
             <% } else { %>
                <li class="page-item"><button class="page-link" id="numBtn" onclick="location.href='<%= request.getContextPath() %>/chalList.bo?currentPage=<%= pi %>'"><%= pi %></button></li>
             <% } %>
          <%} %>
<%--                 <li class="page-item"><button class="page-link" onclick="location.href='<%= request.getContextPath() %>/reportlist.bo?currentPage=<%= p.getCurrentPage() +1 %>'" id="afterBtn">&gt;</button></li> --%>
          <li class="page-item">
            <a class="page-link" href="<%= request.getContextPath() %>/chalList.bo?currentPage=<%= p.getMaxPage() %>" aria-label="Next">
